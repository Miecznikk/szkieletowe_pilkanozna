...
urlpatterns = [
    ...
    path('teams/challenge/default',views.challenge_team,name='challenge'),
    path('teams/challenge/?P<int:challenged_team>',views.challenge_team,name='challenge'),
    path('match/post/?P<int:id>',views.post_score_view,name='post_score'),
    path('match/team_mathes',views.team_matches,name='team_matches'),
    path('match/',views.all_matches,name='all_matches'),
    path('match/?P<int:id>',views.match_detail,name='match_detail'),
]
